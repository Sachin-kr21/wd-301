...
const SigninForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <button type="submit" id="submit" className="w-full bg-gray-700 hover:bg-gray-800 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline-gray mt-4">Sign In</button>
    </form>
  );
};
